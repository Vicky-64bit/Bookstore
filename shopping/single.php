                                ...
                                <div class="cart mt-4 align-items-center">
                                    <?php if (isset($_SESSION['user_id'])) : ?>
                                        ...
                                        ?>
                                            ...
                                            <button id="submit" name="submit" disabled class="btn btn-primary text-uppercase mr-2 px-4"><i class="fas fa-shopping-cart"></i> Added to cart</button>
                                    ...
                                    <?php if (isset($_SESSION['user_id'])) : ?>
                                        ...
                                        ?>
                                            <button value="<?php echo $fetch->id; ?>" type="button" class="btn-delete-wishlist btn btn-primary text-uppercase mr-2 px-4"><i class="fas fa-heart"></i> Added to Wishlist</button>
                                        <?php else : ?>
                                            <button type="submi" class="wishlist-btn btn btn-primary text-uppercase mr-2 px-4"><i class="fas fa-heart"></i> Add to Wishlist</button>
                                        <?php endif; ?>
                                    <?php endif; ?>
        ...
        $(".wishlist-btn").on("click", function(e) {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $(".wishlist-btn").html("<i class='fas fa-heart'></i> Added to wishlist").addClass("btn-delete-wishlist").removeClass("wishlist_btn")
                    ref();
                }
